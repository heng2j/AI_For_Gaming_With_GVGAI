...
public class Agent extends AbstractPlayer{
	...
	public ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
		...
		//Initiated a TNode Object
		TNode rootTNode = new TNode(null, stateStr + stateNum , Types.ACTIONS.ACTION_NIL, stateObs, Double.POSITIVE_INFINITY); 
		

		queue.add(rootTNode);
		queue.add(rootTNode);
		closed.add(rootTNode);
...
//				    childrenList.add(cNodeMap);
				...
				//May put back to the previous scope
			...
			//*
			//Check if currentNode == rootTNode
			
//			if (currentNode.name != rootTNode.name) {
//				
//				System.out.println("Not Equal To rootTNode");
//				
//				
//				if (currentNode.parent != null) {
//					
//					TNode TempPNode = currentNode.parent;
//
//					
//					for (int i=0; i<TempPNode.children.size(); i++) 
//					{ 
//		
//						 if (currentNode.name == TempPNode.children.get(i).name) {
//							 
//							 TempPNode.children.set(i, currentNode);
//					    		
//						    }
//	
//					}
//					
//					while (TempPNode.parent != null) {
//						
//						
//						for (int i=0; i<TempPNode.parent.children.size(); i++) 
//						{ 
//			
//							 if (TempPNode.name == TempPNode.parent.children.get(i).name) {
//								 
//								 TempPNode.parent.children.set(i, TempPNode);
//						    		
//							    }
//	
//						}
...
//			else {	
//				
//				System.out.println("Equal To rootTNode");
//				rootTNode = currentNode;
//					
//			}
...
//			rootNodeChildrenList.add(pNodeMap);
		...
		//Extract nodes from Rootnode
		
		 Queue<TNode> TNodeQ = new LinkedList<TNode>();
		 TNodeQ.add(rootTNode);
		 

//		 TNode tempTNode = TNodeQ.poll();
//         System.out.print("Temp Node Name " + tempTNode.name + " ");
//		 
	     ...
	     while (!TNodeQ.isEmpty()) 
	        {
	            ...
	            TNode tempTNode = TNodeQ.poll();
	            System.out.print(tempTNode.name + " ");
//	            
//	            System.out.println("rootTNode Children: " + rootTNode.children);
//	            
	            
	            if(!tempTNode.children.isEmpty()) {
	            	
		            for (TNode child : tempTNode.children) {
